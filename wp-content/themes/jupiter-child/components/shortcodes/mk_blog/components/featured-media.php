...
// importo mk_options per il titolo
global $mk_options;
    ...
    case 'image':
        if (!Mk_Image_Resize::is_default_thumb($image_src_array[0])) {
            ...
            if ($mk_options['blog_single_title'] == 'true') {
              echo '<div id="title-subtitle">';
              echo '<h2 id="blog-single-title" class="blog-single-title" itemprop="headline">';
              echo the_title();
              echo '</h2>';
              echo '<h4 id="blog-single-subtitle">';
              echo get_secondary_title();
              echo '</h4>';
              echo '<h4 id="blog-single-date">';
              echo the_subtitle();
              echo '</h4>';
              echo '</div>';
            }
